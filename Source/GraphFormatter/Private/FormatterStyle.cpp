...
void FFormatterStyle::Initialize()
{
    if (!StyleSet.IsValid())
    {
        ...
        StyleSet->Set("GraphFormatter.ApplyIcon.Small", new FSlateImageBrush(StyleSet->RootToContentDir(TEXT("icon_Blueprint_StateMachine_16x"), TEXT(".png")), FVector2D(16.0f, 16.0f)));
        StyleSet->Set("GraphFormatter.ApplyIcon", new FSlateImageBrush(StyleSet->RootToContentDir(TEXT("icon_Blueprint_StateMachine_24x"), TEXT(".png")), FVector2D(24.0f, 24.0f)));
